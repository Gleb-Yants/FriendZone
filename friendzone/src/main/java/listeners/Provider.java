...
public class Provider implements ServletContextListener {
    ...
    //public static final String LOGGER_PROP = "resources/log4j.properties";
    public static final String DBPROP = "java:comp/env/jdbc/friendzone";
    public static final String LOGGER_PROP = "C:\\My projects\\FriendZone\\friendzone\\src\\main\\webapp\\resources\\log4j.properties";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        //String log4jConfigFile = servletContext.getInitParameter(LOGGER_PROP);
        ...
        final MessengerDao messDao = new MySQLMessengerDao();
        ...
        servletContext.setAttribute(FRIENDS, friends);//variable for all users (model - friend) in system
